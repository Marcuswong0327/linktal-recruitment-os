    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          // Plain (non-data-conditioned) so a consumer's own sm:max-w-* in
          // className is recognized as the same conflict group by twMerge
          // and wins, instead of losing to this default on selector specificity.
