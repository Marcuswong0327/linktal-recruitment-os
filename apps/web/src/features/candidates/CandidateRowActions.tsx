...
/**
 * Per-row delete action. Delete is a soft delete on the API, so we surface an
 * "Undo" in the success toast that restores the row — the quickest way to
 * exercise the soft-delete/restore round-trip without a separate deleted view.
 */
