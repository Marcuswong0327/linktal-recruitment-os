...
import { StakeholderWorkspace } from '@/features/stakeholder-workspace/StakeholderWorkspace';
...
export default async function StakeholderWorkspacePage({
      ...
      <PageLayout>
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Select one or more companies on the Companies page, then choose &quot;Enrich Data with
            Stakeholders&quot; to open this workspace.
          </p>
  ...
  return <StakeholderWorkspace clientIds={clientIds} />;
}
